...
resource "aws_security_group_rule" "bastion_laptop" {
    ...
    to_port = 22
    protocol = "tcp"
    cidr_blocks = ["0.0.0.0/0"] # Replace with your laptop's IP address or CIDR block
...
# VPN ports 22, 443, 1994, and 943 open to the world
# These rules allow SSH, HTTPS, and OpenVPN connections to the VPN server
...
# backened ALB accepting connections from my vpn on port no 80
...
resource "aws_security_group_rule" "mongodb_vpn_ssh" {
    ...
    # This rule allows SSH connections to the MongoDB instance from the VPN
    protocol = "tcp"
...
resource "aws_security_group_rule" "redis_vpn_ssh" {
    ...
    # This rule allows SSH connections to the redis instance from the VPN
    protocol = "tcp"
...
resource "aws_security_group_rule" "mysql_vpn_ssh" {
    ...
    # This rule allows SSH connections to the mysql instance from the VPN
    protocol = "tcp"
...
resource "aws_security_group_rule" "rabbitmq_vpn_ssh" {
    ...
    # This rule allows SSH connections to the rabbitmq instance from the VPN
    protocol = "tcp"
